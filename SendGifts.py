...
""" Freaking Scrollbar not working... Fix it man! :P """

# As seen in www.tkdocs.com/tutorial/morewidgets.html
...
countrynames = ("Argentina", "Australia", "Belgium", "Brazil", "Canada", "China",
...
def showPopulation(*args):
    ...
    if len(idxs) == 1:
        ...
        statusmsg.set("The population of {} ({}) is {}".format(name, code, popn))
    sentmsg.set('')
...
def sendGift(*args):
    ...
    if len(idxs) == 1:
        ...
        sentmsg.set("Sent {} to leader of {}".format(gifts[gift.get()], name))
...
# the scrollbar
s = ttk.Scrollbar(root, orient=VERTICAL, command=lbox.yview)
