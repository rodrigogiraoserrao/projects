The point of this folder is to contain everything I created related to fractals

The .rar folders contain windows executables for the files of the same name;

For the Mandelbrot set, clicking the screen will zoom in the fractal on that point;
